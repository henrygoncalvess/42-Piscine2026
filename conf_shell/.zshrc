...
# c_debug () {
#   cc -Wall -Extra -Error -g $@ &&
# }

# alias compile=c_comp()
# alias dbg=c_debug()
...
plugins=(git sudo zsh-autosuggestions zsh-syntax-highlighting web-search copyfile dirhistory vi-mode fzf)
...
if command -v oh-my-posh &> /dev/null; then
  eval "$(oh-my-posh init zsh --config "$HOME/42sp/conf_posh/.config/oh_my_posh_config/my-theme.omp.json")"
fi
